...
export default function ToggleFavorite() {
    return (
        <button title='Toggle Favorite' className="invisible absolute right-0 top-0 m-2 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-[var(--color-content-900)] p-1 group-hover/item:visible">
