...
export default function LikeButton() {
    return (
        <button title='Like' className="flex items-center cursor-pointer justify-center absolute top-0 right-0 w-8 h-8 bg-[var(--color-content-900)] rounded-full m-2 invisible group-hover/item:visible p-1">
